...
/* Private typedef -----------------------------------------------------------*/
/* Private define ------------------------------------------------------------*/
#define DP83630_PHY_ADDRESS       0x01 /* Relative to STM322xG-EVAL Board */
...
int ETH_BSP_Config(void)
{
  ...
  EthInitStatus = ETH_MACDMA_Config(DP83630_PHY_ADDRESS); 

  /* Configure the PHY to generate an interrupt on change of link status */
//  Eth_Link_PHYITConfig(DP83630_PHY_ADDRESS);
